...
class Settings(BaseModel):
    ...
    css_mode: Literal["grid", "columns", "single"] = Field(
        default="grid", description="CSS layout mode"
    )
    ...
    def __init__(self, **data):
        ...
        if (
            "openai_api_key" not in data
            or not data["openai_api_key"]
            or data["openai_api_key"] == "sk-your-api-key-here"
        ):
